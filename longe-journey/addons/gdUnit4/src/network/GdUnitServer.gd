...
# Resolve RPC subclasses before compiling type checks (Godot 4.6.2 editor exit lifecycle).
const RPCMessage = preload("res://addons/gdUnit4/src/network/rpc/RPCMessage.gd")
const RPCGdUnitEvent = preload("res://addons/gdUnit4/src/network/rpc/RPCGdUnitEvent.gd")
